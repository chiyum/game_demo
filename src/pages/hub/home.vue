<template>
  <div class="home">
    <div class="home__header" :class="[env]" ref="head">
      <img
        style="width: 130px"
        src="https://reo88.3a1788.tw/img/header/logo.gif"
      />
      <div
        class="flex items-stretch flex-col w-[80px] z-20 border-x-[3px] border-y-[3px] border-[#fff] rounded-[6px] bg-[#257fbb] drop-shadow-[0_1px_3px_rgba(0,0,0,.5)] drop-shadow-xl z-[23] !border-[3px] scale-[0.9] rounded-[10px]"
      >
        <div
          class="flex justify-center items-center font-[700] text-white text-[12px]"
        >
          <div class="img mr-[4px] shrink-0"></div>
          在線人數
        </div>
        <ul class="flex items-center flex-[1.2] mx-[-1px]">
          <li
            class="justify-center items-center flex-[1.5] text-[#FFFFFF] bg-[#3a4d7b] border-[3px] border-[#fff] text-[14px] leading-[1.5] !border-t-[3px] !border-x-[2px] text-center"
          >
            1
          </li>
          <li
      ...
      <div style="display: flex; align-items: center; margin: 0 10px 0 auto">
        <!-- <div class="log_btn reg" id="register">註冊</div> -->
        <div
          class="rounded-[3px] w-[80px] h-[30px] mx-[10px] text-white text-4xl text-shadow flex items-center justify-center bg-gradient-to-b from-[#f8c7d5] to-[#8481cc] cursor-pointer"
          style="text-shadow: rgb(8, 47, 78) 0px 1px 3px"
        >
          登入/註冊
        </div>
        <svg
